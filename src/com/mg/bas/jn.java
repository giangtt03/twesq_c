    ...
    public final byte[] a() {
        ...
        try {
            ...
            while (n3 < this.m.length) {
                System.arraycopy(m.a(this.m[n3]), 0, byArray4, n2, 4);
                n2 += 4;
                ++n3;
            }
            n += byArray4.length;
            ...
            System.arraycopy(m.a(byArray3.length), 0, byArray, n2, 4);
            System.arraycopy(byArray3, 0, byArray, n2 += 4, byArray3.length);
            System.arraycopy(m.a(this.h.length), 0, byArray, n2 += byArray3.length, 4);
            System.arraycopy(this.h, 0, byArray, n2 += 4, this.h.length);
            System.arraycopy(m.a(this.i.length), 0, byArray, n2 += this.h.length, 4);
            System.arraycopy(this.i, 0, byArray, n2 += 4, this.i.length);
            System.arraycopy(m.a(this.j.length), 0, byArray, n2 += this.i.length, 4);
            System.arraycopy(this.j, 0, byArray, n2 += 4, this.j.length);
            System.arraycopy(m.a(byArray4.length), 0, byArray, n2 += this.j.length, 4);
            System.arraycopy(byArray4, 0, byArray, n2 += 4, byArray4.length);
            System.arraycopy(m.a(n4), 0, byArray, n2 += byArray4.length, 4);
            n2 += 4;
            n5 = 0;
            while (n5 < byArrayArray.length) {
                System.arraycopy(m.a(byArrayArray[n5].length), 0, byArray, n2, 4);
